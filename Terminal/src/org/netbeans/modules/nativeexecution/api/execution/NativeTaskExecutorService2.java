...
/**
 * Copied from Netbeans source. This uses cached thread pool instead of
 * RequestProcessor unlike the original implementation, to allow more terminals
 * to be opened.
 *
 * @author Pragalathan M <pragalathanm@gmail.com>
 */
public class NativeTaskExecutorService2 {

    private static final String PREFIX = "NATIVEEXECUTOR2: "; // NOI18N
    private static final ExecutorService processor = Executors.newCachedThreadPool();

    private NativeTaskExecutorService2() {
    }
