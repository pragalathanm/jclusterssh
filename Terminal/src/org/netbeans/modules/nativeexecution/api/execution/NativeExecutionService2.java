...
/**
 * Copied from Netbeans source and uses {@link NativeTaskExecutorService2}. This
 * is a wrapper over an <tt>Executionservice</tt> that handles running
 ...
 */
public final class NativeExecutionService2 {

    private final NativeProcessBuilder processBuilder;
    private final String displayName;
    private final NativeExecutionDescriptor2 descriptor;
    ...
    private NativeExecutionService2(NativeProcessBuilder processBuilder, String displayName, NativeExecutionDescriptor2 descriptor) {
        this.processBuilder = processBuilder;
        this.displayName = displayName;
        this.descriptor = descriptor;
    }

    public static NativeExecutionService2 newService(NativeProcessBuilder processBuilder,
            NativeExecutionDescriptor2 descriptor, String displayName) {
        return new NativeExecutionService2(processBuilder, displayName, descriptor);
    }

    public Future<Integer> run(Runnable callback) {
        ...
        if (IOTerm.isSupported(descriptor.inputOutput)) {
            return runTerm(callback);
        } else {
            return runRegular();
        }
    }

    private Future<Integer> runTerm(Runnable callback) {
        ...
        Callable<Integer> callable = new Callable<Integer>() {
            ...
            public Integer call() throws Exception {
                ...
                try {
                    ...
                    // ensure that the call returns immediately
                    callback.run();
...
//                    boolean ret = super.cancel(mayInterruptIfRunning);
        ...
        NativeTaskExecutorService2.submit(runTask, "start process in term"); // NOI18N
