 ...
 */
@ConvertAsProperties(
        dtd = "-//com.konsole.cluster//StartPage//EN",
        autostore = false
)
...
@ActionID(category = "Window", id = "com.konsole.cluster.StartPageTopComponent")
...
@Messages({
    ...
    "HINT_StartPageTopComponent=This is a StartPage"
})
public final class StartPageTopComponent extends TopComponent {
    ...
    public StartPageTopComponent() throws IOException {
        initComponents();
